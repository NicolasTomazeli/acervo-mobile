const CACHE='acervo-v0.6.0';
const ASSETS=['./','./index.html','./style.css','./app.js','./matcher.js','./visual-client.js','./matcher-worker.js','./manifest.webmanifest','./icons/icon-192.png'];
